  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="mb-12">
        <div className="flex justify-between items-end mb-6">
          ...
          <div className="hidden sm:flex bg-gray-100 p-1.5 rounded-full items-center">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className={`flex items-center text-sm font-bold px-4 py-1.5 rounded-full transition-colors ${step >= i ? 'bg-white shadow-sm text-primary' : 'text-gray-400'}`}>
                {step > i ? <CheckCircle2 size={16} className="mr-1.5"/> : <span className="mr-1.5">{i}.</span>}
                {i === 1 ? 'Info' : i === 2 ? 'Context' : i === 3 ? 'Resume' : 'Review'}
              </div>
            ))}
          </div>
        </div>
      ...
      <Card className="min-h-[400px] flex flex-col relative overflow-hidden bg-white mt-10 shadow-[0_4px_40px_rgba(0,0,0,0.04)]">
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="border-2 border-dashed border-gray-200 hover:border-primary/50 bg-gray-50 rounded-2xl flex-1 flex flex-col items-center justify-center p-12 transition-colors cursor-pointer group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Drag and drop file here</h3>
            ...
            {step === 4 && (
              ...
              >
                ...
                <div className="mt-8 flex justify-center gap-3 bg-gray-50 p-4 rounded-xl text-left border border-gray-100 mx-auto max-w-md">
                   <File className="text-gray-400 mt-1" />
                   <div>
                     <div className="font-bold text-gray-900">aarav_nair_resume.pdf</div>
                     <div className="text-xs text-gray-500">245 KB • Parsed offline</div>
                   </div>
                </div>
              </motion.div>
            )}
        ...
        {/* Form Footer */}
        <div className="border-t border-gray-100 bg-gray-50/50 p-6 flex justify-between items-center px-12">
